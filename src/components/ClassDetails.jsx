    ...
    const getDetailClass = async () => {
      try {
        const response = await axios.get(
          `https://pragos-academy-api-production.up.railway.app/course/` + id
        );
                  ...
                  <div className="text-center">
                    ...
                    <div>
                      ...
                      <p className="indent-8">
                        ...
                        design system. Tidak hanya ditujukan untuk UI/UX
                        Designer ataupun Developer, kelas ini sangat sesuai
                        untuk stakeholder lain agar dapat memudahkan tim dalam
                        bekerja sama. Yuk segera daftar dan kami tunggu di kelas
                        ya!
                      </p>
                    </div>
                    <div className="mb-5">
                      ...
                      <ol className="list-decimal ml-5">
                        ...
                        <li>
                          Anda yang ingin membantu perusahaan lebih optimal
