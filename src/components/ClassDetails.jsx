				...
				<div className="w-full mt-1">
					...
					<div className="gap-12 grid md:grid-cols-5 grid-cols-1">
						<div className="md:col-span-3">
									...
									<div className="h-full flex flex-col">
										...
										<div className="flex gap-2">
											<Button
												...
												iconPosition="right"
												size="md"
												className="text-white my-5 w-full !bg-alert-success text-xs font-normal sm:text-lg sm:text-semibold"
											>
												Join Grup Telegram
											</Button>
											<Button
												...
												className="text-white my-5 w-full text-xs font-normal sm:text-lg sm:text-semibold"
											>
												Chapter
											</Button>
										</div>
							...
							{!currentTopic ? <ContentClass details={details} /> : <ChapterDetail details={selectedChapterContent} />}
						</div>
