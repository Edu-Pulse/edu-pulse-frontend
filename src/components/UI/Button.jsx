  ...
  const buttonClasses = clsx(
    ...
    !outline
      ? {
          ...
          white:
            "bg-white text-black hover:bg-gray-200 transition-all duration-200",
        }[color]
      : {
          primary:
            "border-2 border-darkblue-05 text-black hover:bg-darkblue-05 hover:text-white transition-all duration-200",
          danger:
            "border-2 border-red-600 text-black hover:bg-red-600 hover:text-white transition-all duration-200",
          warning:
...
Button.propTypes = {
  ...
  color: PropTypes.oneOf(["primary", "danger", "success", "warning", "white"]),
