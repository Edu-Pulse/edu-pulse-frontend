        ...
        <div className="overflow-y-scroll md:h-[300px] rounded-lg shadow hidden md:block p-5 bg-gray-100">
          <table className="w-full">
            <thead className="bg-gray-50 border-b-2 border-gray-200">
              <tr>
                <th className="w-30 p-3 text-sm font-semibold tracking-wide text-left">Kode Kelas</th>
                <th className="w-20 p-3 text-sm font-semibold tracking-wide text-left">Kategori</th>
                <th className="p-3 text-sm font-semibold tracking-wide text-left">Nama Kelas</th>
                <th className="w-30 p-3 text-sm font-semibold tracking-wide text-left">Tipe Kelas</th>
                <th className="w-24 p-3 text-sm font-semibold tracking-wide text-left">Level</th>
                <th className="w-24 p-3 text-sm font-semibold tracking-wide text-left">Harga</th>
            ...
            <tbody className="divide-y divide-gray-100">
              <tr className="bg-white">
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                  <a href="#" className="font-bold text-blue-500 hover:underline">UIUX0123</a>
                </td>
                ...
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                  <span className="p-1.5 text-xs font-medium uppercase tracking-wider text-green-800 bg-green-200 rounded-lg bg-opacity-50">Gratis</span>
                </td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Beginner</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Rp 0</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
              ...
              <tr className="bg-gray-50">
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                  <a href="#" className="font-bold text-blue-500 hover:underline">DS0223</a>
                </td>
              ...
              <tr className="bg-white">
                ...
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Data Science</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Data Cleaning untuk Professional</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                  <span className="p-1.5 text-xs font-medium uppercase tracking-wider text-blue-800 bg-blue-500 rounded-lg bg-opacity-50">Premium</span>
                </td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Advanced</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Rp 199,000</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                  <span className="flex gap-3 justify-center">
                      <PencilSquareIcon className="h-5 w-5 rounded-md text-green-800 bg-green-200 cursor-pointer outline outline-offset-2 outline-2" />
                      <TrashIcon className="h-5 w-5 rounded-md text-red-800 bg-red-200 cursor-pointer outline outline-offset-2 outline-2" />
              ...
              <tr className="bg-white">
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                  <a href="#" className="font-bold text-blue-500 hover:underline">PM0123</a>
                </td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Product Management</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Scrum dalam tim kompleks</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                  <span className="p-1.5 text-xs font-medium uppercase tracking-wider text-blue-800 bg-blue-500 rounded-lg bg-opacity-50">Premium</span>
                </td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Intermediate</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Rp 299,000</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                  <span className="flex gap-3 justify-center">
                    <PencilSquareIcon className="h-5 w-5 rounded-md text-green-800 bg-green-200 cursor-pointer outline outline-offset-2 outline-2" />
                    <TrashIcon className="h-5 w-5 rounded-md text-red-800 bg-red-200 cursor-pointer outline outline-offset-2 outline-2" />
              ...
              <tr className="bg-white">
                ...
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Product Management</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Penerapan manajemen Agile</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                  <span className="p-1.5 text-xs font-medium uppercase tracking-wider text-blue-800 bg-blue-500 rounded-lg bg-opacity-50">Premium</span>
                </td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Advanced</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Rp 349,000</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                  <span className="flex gap-3 justify-center">
                    <PencilSquareIcon className="h-5 w-5 rounded-md text-green-800 bg-green-200 cursor-pointer outline outline-offset-2 outline-2" />
                    <TrashIcon className="h-5 w-5 rounded-md text-red-800 bg-red-200 cursor-pointer outline outline-offset-2 outline-2" />
              ...
              <tr className="bg-white">
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                  <a href="#" className="font-bold text-blue-500 hover:underline">AD1023</a>
                </td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Android Development</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Mengenal Android Studio</td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                  <span className="p-1.5 text-xs font-medium uppercase tracking-wider text-green-800 bg-green-200 rounded-lg bg-opacity-50">Gratis</span>
                </td>
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">Beginner</td>
              ...
              <tr className="bg-white">
                <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                  <a href="#" className="font-bold text-blue-500 hover:underline">WD1123</a>
                </td>
