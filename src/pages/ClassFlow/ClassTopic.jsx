...
const ClassTopic = () => {
  ...
  useEffect(() => {
    ...
    const filteredByCategory = filteredByDateAndPromo.filter((classItem) => {
    ...
    <>
              ...
              {isLoading ? (
                ...
                <div className="w-full h-full grid place-content-center">
                  ...
                  <p className="text-gray-700">
                    Yang kamu cari belum ditemukan, yuk cari yang lain
                  </p>
                </div>
              ) : (
                <div className="grid sm:grid-cols-2 gap-6 my-10">
      ...
      >
        <Filters
          ...
          filterByDateAndPromo={filterByDateAndPromo}
          setFilterByDateAndPromo={setFilterByDateAndPromo}
          onCloseDrawer={() => setIsFilterDrawerOpen(!isFilterDrawerOpen)}
        />
      </Drawer>
    </>
  );
