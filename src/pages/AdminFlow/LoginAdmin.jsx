...
function LoginAdmin() {
  ...
  const handleLogin = () => {
    ...
    user
      ? navigate("/dashboard")
      : (console.log("Login gagal"), setIsError(true));
  };
  return (
    <main className="flex h-screen">
      ...
      <section className="md:w-[65%] w-full h-full grid place-content-center">
        <div className="sm:w-[452px] w-[352px] h-[348px] ">
          <h1 className="text-center font-Montserrat text-[24px] font-bold leading-[36px] text-darkblue-05 mb-[24px]">
            Login
          </h1>
          <Input
          ...
          <div className="flex justify-between mt-[16px]">
            ...
            <label className="font-poppins text-[13px] font-normal leading-[18px] text-darkblue-05 mb-1">
              Lupa Kata Sandi
            </label>
          </div>
          <Input
