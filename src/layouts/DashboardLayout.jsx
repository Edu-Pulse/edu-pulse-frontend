  ...
  return (
    <body className=" flex h-[100vh] w-[100vw]">
      <aside className=" w-[20%] h-full bg-darkblue-05">
        <div className="px-5 ">
          <img src={logo} alt="logo-belajar" className=" h-[150px]" />
        </div>
      ...
      <main className=" w-[100vw] ">
        <section className=" flex px-[65px] h-20 gap-x-32 bg-darkblue-06">
          <div className="h-full w-[50%] pt-6 grid place-content-start font-Montserrat text-[24px] font-bold leading-[36px] text-darkblue-05">
            Hi, Admin!
          </div>
        ...
        <section className=" h-[19%] px-20 pt-[13px]  flex justify-between gap-x-6">
          <div className="flex gap-5 w-2/4 h-24 rounded-2xl bg-darkblue-03 ps-9 py-2">
            <img src={Icon} alt="icon-dashboard" width={60} height={60} />
            <div className="py-3">
